 ...
 * 升级职业
*/
export default class UpgradeCareerResponse extends ResponseData
{
    /**
     * 返回值时表示是否成功
     * 
     * @type {boolean}
     * @memberof UpgradeCareerResponse
     */
    ...
    public __params: IResponseParams = { type: "UpgradeCareer" };
    ...
    public static type: string = "UpgradeCareer";
...
/** 注册返回体 */
netManager.registerResponse(UpgradeCareerResponse);
