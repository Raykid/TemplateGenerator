 ...
 * 完成工作
*/
export default class DoWorkResponse extends ResponseData
{
    /**
     * 返回值时表示是否成功
     * 
     * @type {boolean}
     * @memberof DoWorkResponse
     */
    ...
    public __params: IResponseParams = { type: "DoWork" };
    ...
    public static type: string = "DoWork";
...
/** 注册返回体 */
netManager.registerResponse(DoWorkResponse);
